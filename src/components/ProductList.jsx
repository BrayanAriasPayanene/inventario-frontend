...
export default function ProductList({ reload, onEditar, onEliminar }) {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-8 px-6 max-w-6xl mx-auto">
      {productos.map((producto) => (
        // Nuevo div para centrar la tarjeta
        <div key={producto.id} className="flex justify-center">
          <div
            className="relative bg-white dark:bg-gray-800 shadow-lg rounded-xl overflow-hidden border border-gray-200 dark:border-gray-700 hover:shadow-2xl transition w-[250px]"
          >
            {/* Imagen */}
